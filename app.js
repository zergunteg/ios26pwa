...
const triggerCloseBtnBounce = () => {
  closeBtn.classList.remove("press-bounce");
  // Force reflow so animation restarts on rapid repeated taps.
  void closeBtn.offsetWidth;
  closeBtn.classList.add("press-bounce");
};
if (window.PointerEvent) {
  closeBtn.addEventListener("pointerdown", triggerCloseBtnBounce);
} else {
  closeBtn.addEventListener("touchstart", triggerCloseBtnBounce, { passive: true });
}
